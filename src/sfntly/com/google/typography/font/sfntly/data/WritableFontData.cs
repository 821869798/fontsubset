 ...
 * @author Stuart Gill
 */
public sealed class WritableFontData : ReadableFontData
{
     ...
     */
    private WritableFontData(ByteArray array) : base(array)
    {
    }
     ...
     */
    private WritableFontData(WritableFontData data, int offset) : base(data, offset)
    {
    }
     ...
     */
    private WritableFontData(WritableFontData data, int offset, int length) : base(data, offset, length)
    {
     ...
     */
    new public WritableFontData slice(int offset, int length)
    {
     ...
     * @return a slice of the original FontData
     */
    new public WritableFontData slice(int offset)
    {
     ...
     * @
     */
    public void copyFrom(InputStream @is, int length)
    {
     ...
     * @
     */
    public void copyFrom(InputStream @is)
    {
