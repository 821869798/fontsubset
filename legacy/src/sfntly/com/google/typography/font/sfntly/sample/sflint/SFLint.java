...
namespace com.google.typography.font.sfntly.sample.sflint;
...
public class SFLint {
  ...
  private static final void printUsage() {
    Console.WriteLine("SFLint [-?|-h|-help] fontfile");
    Console.WriteLine("find problems with the font file");
  ...
  public void lintFontFile(File fontFile)  {
  ...
  private void lintNameTable(Font font) {
    ...
    foreach(NameEntry entry in name) {
      ...
      if (entry.nameId() == NameId.FontFamilyName.value()) {
        foreach(NameEntry entry2 in name) {
