...
public class HdmxEncoder {
  ...
  public WritableFontData encode(Font sourceFont) {
    HorizontalDeviceMetricsTable hdmx = sourceFont.getTable<HorizontalDeviceMetricsTable>(Tag.hdmx);
    HorizontalMetricsTable hmtx = sourceFont.getTable<HorizontalMetricsTable>(Tag.hmtx);
    MaximumProfileTable maxp = sourceFont.getTable<MaximumProfileTable>(Tag.maxp);
    FontHeaderTable head = sourceFont.getTable<FontHeaderTable>(Tag.head);
