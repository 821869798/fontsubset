...
public class LzcompCompress
{
    ...
    private static readonly int MAX_2BYTE_DIST = 512;
    private static readonly int DIST_MIN = 1;
    private static readonly int DIST_WIDTH = 3;
    private static readonly int LEN_MIN = 2;
    private static readonly int LEN_MIN3 = 3;
    private static readonly int LEN_WIDTH = 3;
    private static readonly int BIT_RANGE = LEN_WIDTH - 1;
    private static readonly int PRELOAD_SIZE = 2 * 32 * 96 + 4 * 256;
    private static readonly int DEFAULT_MAX_COPY_DIST = 0x7fffffff;
    ...
    private void write(byte[] dataIn)
    {
        ...
        Arrays.arraycopy(dataIn, 0, buf, PRELOAD_SIZE, length1);
        encode();
        bits.flush();
    }
